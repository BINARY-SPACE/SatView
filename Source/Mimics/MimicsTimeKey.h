// MIMICSTIMEKEY.H : Mimics Timekey Related Interface Declaration.
//
// This is a part of the SatView(TM) spacecraft operating system.
// Copyright© 1992-2016 by BINARY SPACE, Switzerland.
// All rights reserved.
//
// This source code contains the mimics timekey related interface
...
#ifndef __MIMICSTIMEKEY_H__
#define __MIMICSTIMEKEY_H__
...
class CTimeKeyArray : public CArray<CTimeKey>
{
	// Construction
public:
...
class CTimeTag : public CTimeKey
{
	// Construction
public:
	CTimeTag();
...
class CTimeTagArray : public CArray<CTimeTag>
{
	// Construction
public:
